...
import static com.mirwanda.nottiled.platformer.gameobject.objecttype.BRIDGE;
...
import static com.mirwanda.nottiled.platformer.gameobject.objecttype.SPRING;
...
public class WorldContactListener implements ContactListener {
    ...
    public void eventobject(gameobject myobject){
        ...
        if (qual) {
            ...
            if (o.get( "message" ) != null) {
                String msgText = o.get( "message" ).toString();
                if (!msgText.trim().isEmpty()) {
                    mygame.showMessage(
                            msgText,
                            game.propString(o, "msgpicture", "messagepicture", "picture"),
                            game.propString(o, "msgspeaker", "speaker", "msgname"),
                            game.propString(o, "msgsound", "messagesound", "voice", "msgvoice")
                    );
                }
            }
            ...
            if (o.get( "setaction" ) != null) {
                ...
                if (o.containsKey( "action" )){
                    act = o.get( "action" ).toString().trim();
                }
                if (act==null){
                    act = o.get( "setaction" ).toString().trim();
                }
                ...
                switch (act){
                    case "jump":
                        ...
                        newbrick.pcooldown = (o.containsKey( "cooldown" )) ? Float.parseFloat( o.get( "cooldown" ).toString() ) : 0.1f;
                        Actor a = new Actor();
                    ...
                    for (String sr: sso){
                        switch (sr){
                            case "1":
                                ...
                                mygame.slot1.clearChildren();
                                if (act.equalsIgnoreCase( "none" )) break;
                                if (iconx ==-1 && icony ==-1) break;
                                if (mygame.icons==null) break;
                                mygame.islot1 = new Image(mygame.icons[iconx][icony]);
                                mygame.slot1.add(mygame.islot1).size(160, 160);
                                break;
                            case "2":
                                newbrick.slot=2;
                                mygame.action2=newbrick;
                                mygame.slot2.clearChildren();
                                if (act.equalsIgnoreCase( "none" )) break;
                                if (iconx ==-1 && icony ==-1) break;
                                if (mygame.icons==null) break;

                                mygame.islot2 = new Image(mygame.icons[iconx][icony]);
                                mygame.slot2.add(mygame.islot2).size(160, 160);
                                break;

                            case "3":
                                newbrick.slot=3;
                                mygame.action3=newbrick;
                                mygame.slot3.clearChildren();
                                if (act.equalsIgnoreCase( "none" )) break;
                                if (iconx ==-1 && icony ==-1) break;
                                if (mygame.icons==null) break;

                                mygame.islot3 = new Image(mygame.icons[iconx][icony]);
                                mygame.slot3.add(mygame.islot3).size(160, 160);

                                break;
                            case "4":
                                newbrick.slot=4;
                                mygame.action4=newbrick;
                                mygame.slot4.clearChildren();
                                if (act.equalsIgnoreCase( "none" )) break;
                                if (iconx ==-1 && icony ==-1) break;
                                if (mygame.icons==null) break;

                                mygame.islot4 = new Image(mygame.icons[iconx][icony]);
                                mygame.slot4.add(mygame.islot4).size(160, 160);
            ...
            if (o.get( "premessage" ) != null) {
                String msgText = o.get( "premessage" ).toString();
                if (!msgText.trim().isEmpty()) {
                    mygame.showMessage(
                            msgText,
                            game.propString(o, "msgpicture", "messagepicture", "picture"),
    ...
    public void beginContact(Contact contact) {
        ...
        gameobject o1 = null;
        gameobject o2 = null;
        if (fixA.getUserData() instanceof gameobject) o1 = (gameobject) fixA.getUserData();
        if (fixB.getUserData() instanceof gameobject) o2 = (gameobject) fixB.getUserData();
        ...
        if (check(MONSTER,PLAYERPROJECTILE,o1,o2)){
            ...
            mo.playSfx( mo.sfx );
            mo.HP-=pp.damage;
            if (mygame.isMultiplayerActive) {
                game.DamagePacket dp = new game.DamagePacket();
                dp.objectIndex = mygame.objects.indexOf(mo);
                dp.damage = pp.damage;
                if (mygame.isHost && mygame.netServer != null) {
                    mygame.netServer.sendToAllTCP(dp);
                } else if (mygame.netClient != null) {
                    mygame.netClient.sendTCP(dp);
                }
            }
        ...
        if (check(BLOCK,PLAYERPROJECTILE,o1,o2)){
            ...
            if (mygame.isMultiplayerActive) {
                game.DamagePacket dp = new game.DamagePacket();
                dp.objectIndex = mygame.objects.indexOf(bl);
                dp.damage = pp.damage;
                if (mygame.isHost && mygame.netServer != null) {
                    mygame.netServer.sendToAllTCP(dp);
                } else if (mygame.netClient != null) {
                    ...
                    switch (myobject.objtype){
                        ...
                        case SPRING:
                            if (mygame.player.body.getLinearVelocity().y < 0) {
                                float launch = myobject.impulse > 0 ? myobject.impulse : 4f;
                                mygame.player.body.setLinearVelocity( 0, launch );
                                myobject.triggerSpringBounce();
                                myobject.playSfx( myobject.sfx );
                            }
                            break;
                        case SPIKE:
    ...
    private void detectFootGround(Contact contact) {
        Fixture a = contact.getFixtureA();
        Fixture b = contact.getFixtureB();
        Fixture foot = null;
        Fixture other = null;
        if (a.getUserData() == game.FOOT_SENSOR) {
            foot = a;
            other = b;
        } else if (b.getUserData() == game.FOOT_SENSOR) {
            foot = b;
            other = a;
        } else {
            return;
        ...
        if (mygame.player == null || foot != mygame.player.fixture5) return;
        if (other.isSensor()) return;

        WorldManifold manifold = contact.getWorldManifold();
        Vector2 normal = manifold.getNormal();
        float groundNormalY = foot == a ? normal.y : -normal.y;
        if (groundNormalY > -0.2f) return;

        if (other.getUserData() instanceof gameobject) {
            gameobject ground = (gameobject) other.getUserData();
            if (ground.objtype == BRIDGE && mygame.player.body != null) {
                if (mygame.dropThroughTimer > 0) return;
                float playerFeet = mygame.player.body.getPosition().y - mygame.player.getHeight() / 2f;
                float bridgeTop = ground.body.getPosition().y + ground.getHeight() / 2f;
                if (mygame.player.body.getLinearVelocity().y > 0.05f || playerFeet < bridgeTop - 0.1f) return;
            }
        }

        mygame.groundContacts = 1;
    }
    ...
    public void preSolve(Contact contact, Manifold oldManifold) {
        detectFootGround( contact );

        Fixture fixA = contact.getFixtureA();
        Fixture fixB = contact.getFixtureB();

        if (fixA.getUserData() == game.FOOT_SENSOR || fixB.getUserData() == game.FOOT_SENSOR) {
            Fixture other = fixA.getUserData() == game.FOOT_SENSOR ? fixB : fixA;
            if (other.getUserData() instanceof gameobject) {
                gameobject ground = (gameobject) other.getUserData();
                if (ground.objtype == BRIDGE && mygame.player != null && mygame.player.body != null) {
                    ...
                    float playerFeet = mygame.player.body.getPosition().y - mygame.player.getHeight() / 2f;
                    float bridgeTop = ground.body.getPosition().y + ground.getHeight() / 2f;
                    if (mygame.player.body.getLinearVelocity().y > 0.05f || playerFeet < bridgeTop - 0.1f) {
                        contact.setEnabled(false);
                        return;
                    }
                }
        ...
        gameobject o1 = null;
        gameobject o2 = null;
        if (fixA.getUserData() != null && fixA.getUserData() instanceof gameobject) {
            o1 = (gameobject) fixA.getUserData();
        }
        if (fixB.getUserData() != null && fixB.getUserData() instanceof gameobject) {
            o2 = (gameobject) fixB.getUserData();
        }

        if (o1 != null && o2 != null) {
            gameobject p = null;
            gameobject bridge = null;
            if (o1.objtype == PLAYER && o2.objtype == BRIDGE) {
                p = o1;
                bridge = o2;
            } else if (o2.objtype == PLAYER && o1.objtype == BRIDGE) {
                p = o2;
                bridge = o1;
            }
            ...
            if (p != null && bridge != null) {
                ...
                float playerFeet = p.body.getPosition().y - p.getHeight() / 2f;
                float bridgeTop = bridge.body.getPosition().y + bridge.getHeight() / 2f;

                // Disable collision if moving upwards, or if player's feet are already below the top of the bridge.
                if (p.body.getLinearVelocity().y > 0.05f || playerFeet < bridgeTop - 0.1f) {
                    contact.setEnabled(false);
                } else {
